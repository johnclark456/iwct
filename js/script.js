...
(function() {
	...
	app.directive("iwctNewsletter", function() {
		return {
			restrict: 'E',
			template: "<div style=\"max-width:400px; margin:auto;\" id=\"subscribe\"><h4 style=\"color:inherit; text-align:center\">Subscribe to our newsletter</h4><form name=\"newsForm\" novalidate data-ng-controller=\"newsletterCtrl\"><div data-ng-hide=\"newsletterSubmitted\"><div class=\"form-group\"><label for=\"name\" class=\"sr-only\">Name</label><i class=\"icon-user\"><input type=\"text\" class=\"form-control\" data-ng-model=\"user.name\" placeholder=\"Name\" style=\"color:inherit\"required/></i></div><div class=\"form-group\"><label for=\"email\" class=\"sr-only\">Email</label><i class=\"icon-mail\"><input type=\"email\" style=\"color:inherit\" class=\"form-control\" data-ng-model=\"user.email\" placeholder=\"Email\" required/></i></div><input type=\"submit\" value=\"Submit\" class=\"btn center-block btn-form\" data-ng-click=\"newsForm.$valid && update(user)\" style=\"margin-bottom:30px; text-color:inherit\" data-ng-disabled=\"!newsForm.$valid\" /></div><div data-ng-show=\"newsletterSubmitted\"><h3 style=\"text-align:center; color: inherit\">Thank You</h3></div></form></div>"
		};
	});
